<template>
  <div class="launch">
    <div class="launch-wrapper">
      <section
        ...
        <div class="item" :class="{'normal':item.state == 5}">
          <div class="item-img">
            <span class="img">孟某某</span>
          </div>
          <div class="item-content">
            <div class="title-wrapper">
              <h2 class="title">我的出差申请</h2>
    ...
    <Travelinfo ref="travelinfo" @refresh="refresh" :travelData="travelData"></Travelinfo>
  </div>
</template>
<script type="text/ecmascript-6">
  // 引入 api
  import {getMyTravel} from 'assets/js/api'
  // mock 数据
  ...
  export default {
    created() {
      ...
      mockMyTravel()
      // 获取数据
      this.$http.get(getMyTravel, {}).then((response) => {
